...
// @Filename: /b.ts
////import [|{| "isWriteAccess": true, "isDefinition": true |}g|], { [|{| "isWriteAccess": true, "isDefinition": true |}default|] as [|{| "isWriteAccess": true, "isDefinition": true |}h|] } from "./a";
////[|g|](); [|h|]();

const [f, g0, fDefault, h0, g1, h1] = test.ranges();
const gRanges = [g0, g1];
const hRanges = [h0, h1];
const gs = { definition: "import g", ranges: gRanges };
const hs = { definition: "import h", ranges: hRanges };
verify.referenceGroups(f, [{ definition: "function f(): void", ranges: [f, fDefault] }, gs, hs]);
